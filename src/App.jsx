...
function MetaInput({ label, value, onChange, placeholder, type = "text", isMobile }) {
  return (
    <div>
      ...
      <input type={type} value={value} onChange={e => onChange(e.target.value)} placeholder={placeholder} style={{ display: "block", width: "100%", border: "1px solid var(--rose-200)", borderRadius: 9, padding: isMobile ? "10px 11px" : "12px 14px", fontSize: isMobile ? 13 : 15, fontFamily: "'DM Sans', sans-serif", color: value ? "var(--dark)" : "var(--gray)", background: "var(--warm-white)" }} />
    </div>
  );
}
