    ...
    <div style={{ minHeight: "100vh", background: "var(--cream)", fontFamily: "'DM Sans', sans-serif", color: "var(--dark)" }}>
      ...
      <header style={{ position: "relative", overflow: "hidden", padding: "44px 28px 32px", background: "var(--dark)" }}>
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: 680, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: 13, color: "#7a7068", marginTop: 12, lineHeight: 1.6, maxWidth: 480 }}>
          ...
          {filledApts.length > 0 && (
            <div style={{ display: "flex", gap: 24, marginTop: 20, paddingTop: 18, borderTop: "1px solid rgba(244,241,236,0.1)" }}>
              {[
                ...
                <div key={s.label}>
                  <div style={{ fontSize: 9.5, letterSpacing: 1.2, textTransform: "uppercase", color: "#6a6058", fontWeight: 500 }}>{s.label}</div>
                      ...
                      <div style={{ position: "relative", zIndex: 1 }}>
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12 }}>
                          <div style={{ minWidth: 0 }}>
                            ...
                            <div style={{ fontSize: 11, color: "var(--gray)", marginTop: 5, lineHeight: 1.6 }}>
                              {[
                                apt.address,
                          ...
                          <div style={{ textAlign: "right", flexShrink: 0 }}>
                            ...
                            <div style={{ fontSize: 9, color: "var(--gray)", textTransform: "uppercase", letterSpacing: 1, marginTop: 2 }}>/month</div>
                          </div>
                        </div>
                    ...
                    <div style={{ background: "var(--dark)", padding: "18px 22px 14px", position: "relative", overflow: "hidden" }}>
                      ...
                      <div style={{ position: "relative", zIndex: 1, display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                        <div>
                          ...
                          <div style={{ fontSize: 11, color: "var(--gray)", marginTop: 4 }}>{group.length} apartment{group.length > 1 ? "s" : ""} listed</div>
                        </div>
                        <div style={{ textAlign: "right" }}>
                          <div style={{ fontSize: 9, letterSpacing: 1, textTransform: "uppercase", color: "var(--gray)", marginBottom: 2 }}>Avg / mo</div>
                          ...
                          <tr style={{ borderBottom: "1px solid var(--border)", background: "#faf8f5" }}>
                            ...
                            {group.map(apt => (
                              <th key={apt.id} style={{
                                ...
                                {apt.unit && <div style={{ fontSize: 8.5, fontWeight: 400, color: "var(--gray)", marginTop: 1 }}>Unit {apt.unit}</div>}
        ...
        {view === "input" && showComparison && filledApts.length > 1 && (
          <div style={{ background: "#fff", borderRadius: 16, border: "1.5px solid var(--border)", overflow: "hidden", boxShadow: "0 4px 20px rgba(0,0,0,0.05)" }}>
            <div style={{ padding: "15px 20px", background: "var(--dark)", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              ...
              <span style={{ fontSize: 9, color: "var(--gray)" }}>sorted low → high</span>
            </div>
            <div style={{ overflowX: "auto" }}>
