...
export default function App() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#fefcfd", fontFamily: "'DM Sans', sans-serif", color: "var(--dark)" }}>
      ...
      {/* ─── HEADER ─── */}
      <header style={{ position: "relative", overflow: "hidden", padding: "44px 28px 32px", background: "linear-gradient(135deg, #fbeaef 0%, #f6d5df 100%)" }}>
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: 680, margin: "0 auto" }}>
          <div style={{ fontSize: 10.5, letterSpacing: 3.5, textTransform: "uppercase", color: "var(--rose-600)", marginBottom: 10, fontWeight: 600 }}>Los Angeles · Apartment Finder</div>
          <h1 style={{ fontFamily: "'DM Serif Display', serif", fontSize: 34, fontWeight: 400, color: "var(--rose-900)", lineHeight: 1.15, letterSpacing: -0.5 }}>
          ...
          {filledApts.length > 0 && (
            <div style={{ display: "flex", gap: 24, marginTop: 20, paddingTop: 18, borderTop: "1px solid rgba(220,86,126,0.2)" }}>
              {[
      ...
      <div style={{ maxWidth: 680, margin: "0 auto", padding: "24px 20px 80px" }}>
              ...
              return (
                <div key={apt.id} className="apt-card" style={{ marginBottom: 16, animationDelay: `${idx * 0.07}s` }}>
                  <div style={{
                    ...
                    {/* Pink gradient hero */}
                    <div style={{ background: "linear-gradient(135deg, #fbeaef 0%, #f6d5df 100%)", padding: "20px 22px 16px", position: "relative", overflow: "hidden" }}>
                      ...
                      <div style={{ position: "relative", zIndex: 1 }}>
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12 }}>
                          <div style={{ minWidth: 0 }}>
                            ...
                            <div style={{ fontFamily: "'DM Serif Display', serif", fontSize: 21, color: "var(--rose-900)", lineHeight: 1.2, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                          ...
                          <div style={{ textAlign: "right", flexShrink: 0 }}>
                            <div style={{ fontFamily: "'DM Serif Display', serif", fontSize: 27, color: "var(--rose-600)", lineHeight: 1 }}>${total.toLocaleString()}</div>
              ...
              return (
                <div key={name} className="apt-card" style={{ marginBottom: 20, animationDelay: `${nIdx * 0.08}s` }}>
                  <div style={{ background: "#fff", borderRadius: 18, border: "1.5px solid var(--rose-200)", overflow: "hidden", boxShadow: "0 3px 16px rgba(0,0,0,0.05)" }}>
                    {/* Area header */}
                    <div style={{ background: "linear-gradient(135deg, #fbeaef 0%, #f6d5df 100%)", padding: "18px 22px 14px", position: "relative", overflow: "hidden" }}>
                      ...
                      <div style={{ position: "relative", zIndex: 1, display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                        <div>
                          ...
                          <div style={{ fontFamily: "'DM Serif Display', serif", fontSize: 22, color: "var(--rose-900)", lineHeight: 1.2 }}>{name}</div>
                        ...
                        <div style={{ textAlign: "right" }}>
                          ...
                          <div style={{ fontFamily: "'DM Serif Display', serif", fontSize: 20, color: "var(--rose-600)" }}>${groupAvg.toLocaleString()}</div>
                          {group.length > 1 && (
                            <div style={{ fontSize: 9.5, color: "var(--rose-700)", marginTop: 3 }}>
                      ...
                      <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12 }}>
                        <thead>
                          <tr style={{ borderBottom: "1px solid var(--rose-200)", background: "#faf8f5" }}>
                            <th style={{ textAlign: "left", padding: "9px 14px", color: "var(--rose-700)", fontWeight: 600, fontSize: 9.5, textTransform: "uppercase", letterSpacing: 0.8, width: "38%" }}>Category</th>
                            {group.map(apt => (
                              <th key={apt.id} style={{
        ...
        {view === "input" && showComparison && filledApts.length > 1 && (
          <div style={{ background: "#fff", borderRadius: 16, border: "1.5px solid var(--rose-200)", overflow: "hidden", boxShadow: "0 4px 20px rgba(0,0,0,0.05)" }}>
            <div style={{ padding: "15px 20px", background: "linear-gradient(135deg, #fbeaef 0%, #f6d5df 100%)", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
