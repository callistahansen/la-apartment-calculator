...
export default function App() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#fefcfd", fontFamily: "'DM Sans', sans-serif", color: "var(--dark)" }}>
      ...
      {/* ─── HEADER ─── */}
      <header style={{ position: "relative", overflow: "hidden", padding: isMobile ? "28px 18px 22px" : "44px 28px 32px", background: "linear-gradient(135deg, #fbeaef 0%, #f6d5df 100%)" }}>
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: 680, margin: "0 auto" }}>
          <div style={{ fontSize: 10.5, letterSpacing: 3.5, textTransform: "uppercase", color: "var(--rose-600)", marginBottom: 10, fontWeight: 600 }}>RentWise</div>
          ...
          <p style={{ fontSize: 13, color: "var(--rose-800)", marginTop: 12, lineHeight: 1.6, maxWidth: 480 }}>
            ...
            <div className="header-stats" style={{ display: "flex", gap: isMobile ? "14px 18px" : 24, marginTop: 20, paddingTop: 18, borderTop: "1px solid rgba(220,86,126,0.2)", flexWrap: isMobile ? "wrap" : "nowrap" }}>
              {[
                ...
                <div key={s.label}>
                  ...
                  <div style={{ fontSize: 15, fontWeight: 700, color: "var(--rose-900)", marginTop: 3 }}>{s.value}</div>
                </div>
              ))}
            </div>
          )}
      ...
      {/* ─── NAV ─── */}
      <div className="nav-container" style={{ maxWidth: 680, margin: "0 auto", padding: isMobile ? "16px 14px 0" : "20px 20px 0" }}>
          ...
          {[
            ...
            return (
              <button key={tab.key} onClick={() => {
                ...
                flex: 1, padding: isMobile ? "8px 3px" : "9px 4px", border: "none", borderRadius: 9, cursor: isDisabled ? "default" : "pointer",
                ...
                fontFamily: "'DM Sans', sans-serif", fontSize: isMobile ? 10 : 11.5, fontWeight: 600,
                transition: "all 0.2s ease", textAlign: "center", lineHeight: 1.3, opacity: isDisabled ? 0.5 : 1
              }}>
                {tab.label}
                <div className="nav-tab-sub" style={{ fontSize: 8.5, fontWeight: 400, opacity: 0.6, marginTop: 1 }}>{tab.sub}</div>
              </button>
            );
          })}
        </div>
      ...
      {/* ─── BODY ─── */}
      <div className="body-container" style={{ maxWidth: 680, margin: "0 auto", padding: isMobile ? "18px 14px 60px" : "24px 20px 80px" }}>
                      ...
                      <div style={{ position: "relative", zIndex: 1 }}>
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12 }}>
                          <div style={{ minWidth: 0 }}>
                            ...
                            <div className="card-hero-title" style={{ fontFamily: "'DM Serif Display', serif", fontSize: isMobile ? 19 : 21, color: "var(--rose-900)", lineHeight: 1.2, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                          ...
                          <div style={{ textAlign: "right", flexShrink: 0 }}>
                            <div className="card-hero-price" style={{ fontFamily: "'DM Serif Display', serif", fontSize: isMobile ? 23 : 27, color: "var(--rose-600)", lineHeight: 1 }}>${total.toLocaleString()}</div>
                    ...
                    <div style={{ background: "linear-gradient(135deg, #fbeaef 0%, #f6d5df 100%)", padding: isMobile ? "16px 18px 12px" : "18px 22px 14px", position: "relative", overflow: "hidden" }}>
                      ...
                      <div style={{ position: "relative", zIndex: 1, display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                        <div>
                          ...
                          <div style={{ fontFamily: "'DM Serif Display', serif", fontSize: isMobile ? 19 : 22, color: "var(--rose-900)", lineHeight: 1.2 }}>{name}</div>
