    ...
    <div style={{ minHeight: "100vh", background: "var(--cream)", fontFamily: "'DM Sans', sans-serif", color: "var(--dark)" }}>
      ...
      <header style={{ position: "relative", overflow: "hidden", padding: "44px 28px 32px", background: "var(--dark)" }}>
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: 680, margin: "0 auto" }}>
          ...
          <h1 style={{ fontFamily: "'DM Serif Display', serif", fontSize: 34, fontWeight: 400, color: "#ffffff", lineHeight: 1.15, letterSpacing: -0.5 }}>
            True Monthly Cost <span style={{ fontStyle: "italic", color: "var(--gold)" }}>Calculator</span>
          </h1>
          <p style={{ fontSize: 13, color: "#ddd6cc", marginTop: 12, lineHeight: 1.6, maxWidth: 480 }}>
          ...
          {filledApts.length > 0 && (
            <div style={{ display: "flex", gap: 24, marginTop: 20, paddingTop: 18, borderTop: "1px solid rgba(244,241,236,0.1)" }}>
              {[
                ...
                <div key={s.label}>
                  <div style={{ fontSize: 9.5, letterSpacing: 1.2, textTransform: "uppercase", color: "#c4bdb4", fontWeight: 500 }}>{s.label}</div>
                  <div style={{ fontSize: 15, fontWeight: 600, color: "#ffffff", marginTop: 3 }}>{s.value}</div>
                </div>
              ))}
            </div>
          )}
                        ...
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12 }}>
                          <div style={{ minWidth: 0 }}>
                            <div style={{ display: "flex", alignItems: "center", gap: 7, marginBottom: 5, flexWrap: "wrap" }}>
                              ...
                              {apt.neighborhood && (
                                <span style={{ fontSize: 9, letterSpacing: 0.8, color: "#f5d89f", background: "rgba(196,168,130,0.3)", padding: "2px 8px", borderRadius: 4, fontWeight: 600 }}>
                                  📍 {apt.neighborhood}
                                </span>
                              )}
                            </div>
                            <div style={{ fontFamily: "'DM Serif Display', serif", fontSize: 21, color: "#ffffff", lineHeight: 1.2, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                              {apt.name || `Apartment ${apartments.findIndex(a => a.id === apt.id) + 1}`}
                            </div>
                            <div style={{ fontSize: 11, color: "#d4cdc2", marginTop: 5, lineHeight: 1.6 }}>
                              {[
                                apt.address,
                          ...
                          <div style={{ textAlign: "right", flexShrink: 0 }}>
                            ...
                            <div style={{ fontSize: 9, color: "#c4bdb4", textTransform: "uppercase", letterSpacing: 1, marginTop: 2 }}>/month</div>
                          </div>
                        </div>
                  ...
                  <div style={{ background: "#fff", borderRadius: 18, border: "1.5px solid var(--border)", overflow: "hidden", boxShadow: "0 3px 16px rgba(0,0,0,0.05)" }}>
                    ...
                    <div style={{ background: "var(--dark)", padding: "18px 22px 14px", position: "relative", overflow: "hidden" }}>
                      ...
                      <div style={{ position: "relative", zIndex: 1, display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                        <div>
                          <div style={{ fontSize: 9, letterSpacing: 2, textTransform: "uppercase", color: "#c4b8ff", fontWeight: 600, marginBottom: 4 }}>📍 Neighborhood</div>
                          <div style={{ fontFamily: "'DM Serif Display', serif", fontSize: 22, color: "#ffffff", lineHeight: 1.2 }}>{name}</div>
                          <div style={{ fontSize: 11, color: "#d4cdc2", marginTop: 4 }}>{group.length} apartment{group.length > 1 ? "s" : ""} listed</div>
                        </div>
                        <div style={{ textAlign: "right" }}>
                          <div style={{ fontSize: 9, letterSpacing: 1, textTransform: "uppercase", color: "#c4bdb4", marginBottom: 2 }}>Avg / mo</div>
                          <div style={{ fontFamily: "'DM Serif Display', serif", fontSize: 20, color: "var(--gold)" }}>${groupAvg.toLocaleString()}</div>
                          {group.length > 1 && (
                            <div style={{ fontSize: 9.5, color: "#d4cdc2", marginTop: 3 }}>
        ...
        {view === "input" && showComparison && filledApts.length > 1 && (
          <div style={{ background: "#fff", borderRadius: 16, border: "1.5px solid var(--border)", overflow: "hidden", boxShadow: "0 4px 20px rgba(0,0,0,0.05)" }}>
            <div style={{ padding: "15px 20px", background: "var(--dark)", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              ...
              <span style={{ fontSize: 9, color: "#c4bdb4" }}>sorted low → high</span>
            </div>
            <div style={{ overflowX: "auto" }}>
