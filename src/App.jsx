...
const globalCss = `
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  :root {
    ...
    --border: #f6d5df; --white: #fff; --warm-white: #fefdfb;
  }
  input:focus, textarea:focus { outline: none; border-color: var(--rose-400) !important; box-shadow: 0 0 0 3px rgba(220,86,126,0.15) !important; }
  ...
  .grain { position: fixed; inset: 0; pointer-events: none; z-index: 999; opacity: 0.02;
  ...
  .ripple::after { content:''; position:absolute; border-radius:50%; background:rgba(212,43,94,0.2); width:100%; height:100%; top:0; left:0; transform:scale(0); transition:transform 0.5s, opacity 0.5s; opacity:0; }
  .ripple:active::after { transform:scale(2.5); opacity:1; transition:transform 0s, opacity 0s; }
  input[type="number"]::-webkit-outer-spin-button,
  input[type="number"]::-webkit-inner-spin-button { -webkit-appearance: none; margin: 0; }
  input[type="number"] { -moz-appearance: textfield; appearance: textfield; }
  input[type="date"] { -webkit-appearance: none; appearance: none; display: block; width: 100%; max-width: 100%; box-sizing: border-box; }
`;
...
export default function App() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#fefcfd", fontFamily: "'DM Sans', sans-serif", color: "var(--dark)" }}>
      <div className="grain" />
      ...
      <header style={{ position: "relative", overflow: "hidden", padding: isMobile ? "28px 18px 22px" : "52px 40px 38px", background: "linear-gradient(135deg, #fbeaef 0%, #f6d5df 100%)" }}>
        <div style={{ position: "absolute", inset: 0, background: "radial-gradient(ellipse 80% 60% at 75% 40%, rgba(220,86,126,0.08) 0%, transparent 70%), radial-gradient(ellipse 60% 50% at 20% 80%, rgba(169,35,75,0.05) 0%, transparent 60%)", pointerEvents: "none" }} />
        <div style={{ position: "absolute", top: -50, right: -30, width: 200, height: 200, borderRadius: "50%", border: "1px solid rgba(220,86,126,0.12)", pointerEvents: "none" }} />
        <div style={{ position: "absolute", top: -20, right: 40, width: 120, height: 120, borderRadius: "50%", border: "1px solid rgba(220,86,126,0.08)", pointerEvents: "none" }} />
        <div style={{ position: "absolute", bottom: -40, left: -20, width: 160, height: 160, borderRadius: "50%", border: "1px solid rgba(169,35,75,0.1)", pointerEvents: "none" }} />
        <div style={{ position: "relative", zIndex: 1, maxWidth: isMobile ? 680 : 960, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: isMobile ? 13 : 15, color: "var(--rose-800)", marginTop: 12, lineHeight: 1.6, maxWidth: isMobile ? 480 : 600 }}>
            Compare the real all-in cost of every apartment — rent, utilities, parking, and everything in between.
          </p>
          {filledApts.length > 0 && (
            <div className="header-stats" style={{ display: "flex", gap: isMobile ? "14px 18px" : 24, marginTop: 20, paddingTop: 18, borderTop: "1px solid rgba(220,86,126,0.2)", flexWrap: isMobile ? "wrap" : "nowrap" }}>
              {[
      ...
      {/* ─── NAV ─── */}
      <div className="nav-container" style={{ maxWidth: isMobile ? 680 : 960, margin: "0 auto", padding: isMobile ? "16px 14px 0" : "24px 40px 0" }}>
        <div style={{ display: "flex", gap: 5, background: "#fff", borderRadius: 12, padding: 4, border: "1.5px solid var(--rose-100)", boxShadow: "0 2px 8px rgba(212,43,94,0.06)" }}>
          {[
            ...
            return (
              ...
              }} className="nav-tab" style={{
                flex: 1, padding: isMobile ? "8px 3px" : "11px 8px", border: "none", borderRadius: 9, cursor: isDisabled ? "default" : "pointer",
                background: isActive ? "linear-gradient(135deg, var(--rose-500) 0%, var(--rose-600) 100%)" : "transparent",
                color: isActive ? "#fff" : isDisabled ? "#ccc" : "var(--rose-900)",
                fontFamily: "'DM Sans', sans-serif", fontSize: isMobile ? 10 : 13, fontWeight: 600,
                transition: "all 0.2s ease", textAlign: "center", lineHeight: 1.3, opacity: isDisabled ? 0.5 : 1
              }}>
                {tab.label}
                <div className="nav-tab-sub" style={{ fontSize: isMobile ? 8.5 : 9.5, fontWeight: 400, opacity: 0.6, marginTop: 1 }}>{tab.sub}</div>
              </button>
            );
          })}
        </div>
      ...
      {/* ─── BODY ─── */}
      <div className="body-container" style={{ maxWidth: isMobile ? 680 : 960, margin: "0 auto", padding: isMobile ? "18px 14px 60px" : "28px 40px 80px" }}>
          ...
          <>
            {filledApts.length === 0 ? (
              <div style={{ textAlign: "center", padding: "72px 24px", background: "#fff", borderRadius: 18, border: "1.5px solid var(--rose-200)" }}>
                ...
                <div style={{ fontSize: 12.5, color: "var(--rose-700)" }}>Go to <strong>Input</strong> to add your first apartment.</div>
              </div>
              ...
              return (
                <div key={apt.id} className="apt-card" style={{ marginBottom: 16, animationDelay: `${idx * 0.07}s` }}>
                  <div style={{
                    ...
                    {/* Pink gradient hero */}
                    <div className="card-hero" style={{ background: "linear-gradient(135deg, #fbeaef 0%, #f6d5df 100%)", padding: isMobile ? "16px 18px 14px" : "20px 22px 16px", position: "relative", overflow: "hidden" }}>
                      <div style={{ position: "absolute", inset: 0, background: "radial-gradient(ellipse 60% 80% at 90% 50%, rgba(220,86,126,0.08) 0%, transparent 70%)", pointerEvents: "none" }} />
                      <div style={{ position: "relative", zIndex: 1 }}>
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12 }}>
                            ...
                            <div style={{ display: "flex", alignItems: "center", gap: 7, marginBottom: 5, flexWrap: "wrap" }}>
                              {(isCheapest || isMostExpensive) && (
                                <span style={{
                                  ...
                                  background: isCheapest ? "var(--green)" : "#dc567e", color: "#fff",
                                  padding: "3px 9px", borderRadius: 4
                                }}>{isCheapest ? "✓ Lowest Cost" : "⚠ Highest Cost"}</span>
                              )}
                              {apt.neighborhood && (
                                <span style={{ fontSize: 9, letterSpacing: 0.8, color: "var(--rose-700)", background: "rgba(220,86,126,0.15)", padding: "2px 8px", borderRadius: 4, fontWeight: 600 }}>
                                  📍 {apt.neighborhood}
                                </span>
                              )}
                            </div>
                            <div className="card-hero-title" style={{ fontFamily: "'DM Serif Display', serif", fontSize: isMobile ? 19 : 24, color: "var(--rose-900)", lineHeight: 1.2, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                              {apt.name || `Apartment ${apartments.findIndex(a => a.id === apt.id) + 1}`}
                            </div>
                            <div style={{ fontSize: 11, color: "var(--rose-700)", marginTop: 5, lineHeight: 1.6 }}>
                              {[
                                apt.address,
                          ...
                          <div style={{ textAlign: "right", flexShrink: 0 }}>
                            <div className="card-hero-price" style={{ fontFamily: "'DM Serif Display', serif", fontSize: isMobile ? 23 : 32, color: "var(--rose-600)", lineHeight: 1 }}>${total.toLocaleString()}</div>
                            <div style={{ fontSize: 9, color: "var(--rose-600)", textTransform: "uppercase", letterSpacing: 1, marginTop: 2, fontWeight: 600 }}>/month</div>
                          </div>
                        </div>
                    ...
                    {/* 3-col body */}
                    <div className="cards-body-grid" style={{ padding: isMobile ? "16px 16px 18px" : "20px 22px 22px", display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1.1fr 0.9fr 0.9fr", gap: isMobile ? 14 : 20 }}>
                      {/* Monthly */}
                      <div>
                        <div style={{ fontSize: 9, letterSpacing: 1.5, textTransform: "uppercase", color: "var(--rose-500)", fontWeight: 600, marginBottom: 11 }}>💰 Monthly</div>
                        ...
                        {apt.sqft && total > 0 && (
                          <div style={{ marginTop: 12, paddingTop: 9, borderTop: "1px solid var(--rose-200)", fontSize: 10.5, color: "var(--rose-700)" }}>
                      ...
                      {/* Move-In */}
                      <div>
                        <div style={{ fontSize: 9, letterSpacing: 1.5, textTransform: "uppercase", color: "var(--rose-400)", fontWeight: 600, marginBottom: 11 }}>📋 Move-In</div>
                        {moveInItems.map(f => {
                          ...
                          return (
                            <div key={f.key} style={{ display: "flex", alignItems: "center", gap: 7, marginBottom: 7 }}>
                              ...
                              <span style={{ fontSize: 12, fontWeight: 600, color: "var(--rose-400)", flexShrink: 0 }}>${v.toLocaleString()}</span>
                            </div>
                          );
                        })}
                        ...
                        {moveInTotal > 0 && (
                          <div style={{ marginTop: 12, paddingTop: 9, borderTop: "1px solid var(--rose-200)" }}>
                            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
                              <span style={{ fontSize: 10.5, color: "var(--rose-700)" }}>Total</span>
                              <span style={{ fontSize: 14, fontWeight: 700, color: "var(--rose-400)" }}>${moveInTotal.toLocaleString()}</span>
                            </div>
                            <div style={{ fontSize: 9.5, color: "var(--rose-700)", marginTop: 3 }}>
                      ...
                      <div style={{ display: "flex", flexDirection: "column" }}>
                        <div style={{ fontSize: 9, letterSpacing: 1.5, textTransform: "uppercase", color: "var(--rose-700)", fontWeight: 600, marginBottom: 11 }}>📝 Notes</div>
                        ...
                        <button onClick={() => { setView("input"); setShowComparison(false); setActiveTab(apt.id); }}
                          style={{
                            marginTop: 14, padding: "7px 13px", border: "1px solid var(--rose-200)", borderRadius: 8,
                            background: "var(--cream)", cursor: "pointer", fontSize: 11.5, color: "var(--rose-700)",
                            fontFamily: "'DM Sans', sans-serif", fontWeight: 500, transition: "all 0.15s", alignSelf: "flex-start"
                          }}
                          onMouseEnter={e => { e.currentTarget.style.borderColor = "var(--rose-500)"; e.currentTarget.style.color = "var(--rose-500)"; }}
                          onMouseLeave={e => { e.currentTarget.style.borderColor = "var(--rose-200)"; e.currentTarget.style.color = "var(--rose-700)"; }}
                        >✏️ Edit</button>
                      </div>
                    </div>
                  </div>
        ...
        {view === "neighborhoods" && (
          <>
                  ...
                  <div style={{ background: "#fff", borderRadius: 18, border: "1.5px solid var(--rose-200)", overflow: "hidden", boxShadow: "0 3px 16px rgba(0,0,0,0.05)" }}>
                    ...
                    <div style={{ background: "linear-gradient(135deg, #fbeaef 0%, #f6d5df 100%)", padding: isMobile ? "16px 18px 12px" : "18px 22px 14px", position: "relative", overflow: "hidden" }}>
                      ...
                      <div style={{ position: "relative", zIndex: 1, display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                        <div>
                          <div style={{ fontSize: 9, letterSpacing: 2, textTransform: "uppercase", color: "var(--rose-600)", fontWeight: 600, marginBottom: 4 }}>📍 Neighborhood</div>
                          <div style={{ fontFamily: "'DM Serif Display', serif", fontSize: isMobile ? 19 : 26, color: "var(--rose-900)", lineHeight: 1.2 }}>{name}</div>
                          <div style={{ fontSize: 11, color: "var(--rose-700)", marginTop: 4 }}>{group.length} apartment{group.length > 1 ? "s" : ""} listed</div>
                        </div>
                        <div style={{ textAlign: "right" }}>
                          <div style={{ fontSize: 9, letterSpacing: 1, textTransform: "uppercase", color: "var(--rose-600)", marginBottom: 2, fontWeight: 600 }}>Avg / mo</div>
                      ...
                      <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12 }}>
                        <thead>
                          <tr style={{ borderBottom: "1px solid var(--rose-200)", background: "#faf8f5" }}>
                            <th style={{ textAlign: "left", padding: isMobile ? "7px 10px" : "9px 14px", color: "var(--rose-700)", fontWeight: 600, fontSize: 9.5, textTransform: "uppercase", letterSpacing: 0.8, width: "38%" }}>Category</th>
                            {group.map(apt => (
                              <th key={apt.id} style={{
                                ...
                                {apt.unit && <div style={{ fontSize: 8.5, fontWeight: 400, color: "#c4bdb4", marginTop: 1 }}>Unit {apt.unit}</div>}
                        ...
                        <tbody>
                          ...
                          {group.some(a => a.sqft && getTotal(a) > 0) && (
                            <tr style={{ borderTop: "1px solid var(--rose-200)" }}>
                              <td style={{ padding: "7px 14px", color: "var(--rose-700)", fontSize: 11 }}>Cost / Sq Ft</td>
                              {group.map(apt => { const t = getTotal(apt), sq = Number(apt.sqft); return <td key={apt.id} style={{ textAlign: "right", padding: "7px 12px", color: "var(--rose-700)", fontSize: 11 }}>{sq && t > 0 ? `$${(t/sq).toFixed(2)}/sqft` : "—"}</td>; })}
                            </tr>
                          )}
                          {/* Move-in row */}
                          {group.some(a => getMoveInTotal(a) > 0) && (
                            <tr style={{ borderTop: "1px solid var(--rose-200)", background: "rgba(122,156,189,0.04)" }}>
                              <td style={{ padding: "7px 14px", color: "var(--rose-400)", fontSize: 11, fontWeight: 500 }}>📋 Move-In</td>
                              {group.map(apt => { const mi = getMoveInTotal(apt); return <td key={apt.id} style={{ textAlign: "right", padding: "7px 12px", color: mi > 0 ? "var(--rose-400)" : "#ccc", fontSize: 11, fontWeight: mi > 0 ? 500 : 400 }}>{mi > 0 ? `$${mi.toLocaleString()}` : "—"}</td>; })}
                            </tr>
                          )}
                          {/* Date available row */}
                          {group.some(a => a.dateAvailable) && (
                            <tr style={{ borderTop: "1px solid var(--rose-200)" }}>
                              <td style={{ padding: "7px 14px", color: "var(--rose-700)", fontSize: 11 }}>📅 Available</td>
                              {group.map(apt => (
            ...
            {filledApts.some(a => !a.neighborhood?.trim()) && (
              <div style={{ marginTop: 8, padding: "14px 18px", borderRadius: 12, background: "var(--rose-50)", border: "1px solid rgba(196,168,130,0.3)" }}>
          ...
          <>
                ...
                <div key={apt.id} className="apt-card" style={{ marginBottom: 12, animationDelay: `${idx * 0.06}s` }}>
                  <div style={{
                    ...
                    <div onClick={() => setActiveTab(isOpen ? null : apt.id)} style={{ cursor: "pointer", padding: "16px 20px", display: "flex", alignItems: "center", gap: 14, userSelect: "none" }}>
                      <div style={{
                        width: 36, height: 36, borderRadius: 12, background: isOpen ? "linear-gradient(135deg, var(--rose-500) 0%, var(--rose-600) 100%)" : "var(--rose-100)",
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <div style={{ fontSize: 11.5, color: "var(--rose-700)", marginTop: 2, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                          {[
                      ...
                      <div style={{ textAlign: "right", flexShrink: 0 }}>
                        ...
                        <div style={{ fontSize: 9.5, color: "var(--rose-700)", textTransform: "uppercase", letterSpacing: 1.2, fontWeight: 500 }}>/mo</div>
                      </div>
                    ...
                    <div className={`card-body ${isOpen ? "open" : ""}`}>
                      <div style={{ padding: "22px 20px 20px" }}>
                        ...
                        {/* Meta fields — 3 rows */}
                        <div className="meta-grid-2col" style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 10, marginBottom: 10 }}>
                        ...
                        <div className="meta-grid-2col" style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1.6fr 1fr", gap: 10, marginBottom: 10 }}>
                        ...
                        <div className="meta-grid-3col" style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr 1.2fr", gap: 10, marginBottom: 22 }}>
                        ...
                        {section === "costs" && (
                          <>
                            <div style={{ fontSize: 9.5, letterSpacing: 1.8, textTransform: "uppercase", color: "var(--rose-700)", fontWeight: 600, marginBottom: 10 }}>Monthly Costs</div>
                            {COST_CATEGORIES.map(cat => {
                              const val = parseFloat(apt.costs[cat.key]) || 0;
                              return (
                                <div key={cat.key} style={{ display: "flex", alignItems: "center", gap: 10, padding: "7px 0", borderBottom: cat.key === "rent" ? "1.5px solid var(--rose-500)" : "1px solid var(--border)" }}>
                                  ...
                                  <div style={{ position: "relative", width: 108 }}>
                                    ...
                                    <input type="number" min="0" value={apt.costs[cat.key]} onChange={e => update(apt.id, cat.key, e.target.value)} onWheel={e => e.preventDefault()} placeholder="0"
                                      style={{ width: "100%", padding: "7px 10px 7px 24px", border: cat.key === "rent" ? "1.5px solid var(--rose-500)" : "1px solid var(--border)", borderRadius: 8, fontSize: 13, fontFamily: "'DM Sans', sans-serif", background: cat.key === "rent" ? "var(--rose-50)" : "var(--warm-white)", color: "var(--dark)", transition: "border-color 0.2s, box-shadow 0.2s" }}
                                    />
                                  </div>
                                  <span style={{ fontSize: 10.5, color: "var(--rose-700)", width: 36, textAlign: "right", flexShrink: 0 }}>{val > 0 && total > 0 ? `${((val / total) * 100).toFixed(0)}%` : ""}</span>
                                </div>
                              );
                            })}
                            ...
                            {apt.sqft && total > 0 && <div style={{ textAlign: "right", fontSize: 11, color: "var(--rose-700)", marginTop: 4 }}>${(total / Number(apt.sqft)).toFixed(2)} per sqft/mo</div>}
                          </>
                        )}
                        ...
                        {section === "movein" && (
                          <>
                            <div style={{ fontSize: 9.5, letterSpacing: 1.8, textTransform: "uppercase", color: "var(--rose-700)", fontWeight: 600, marginBottom: 10 }}>Move-In Costs</div>
                            {MOVEIN_FIELDS.map(f => (
                              <div key={f.key} style={{ display: "flex", alignItems: "center", gap: 10, padding: "7px 0", borderBottom: "1px solid var(--rose-200)" }}>
                                ...
                                <div style={{ position: "relative", width: 108 }}>
                                  <span style={{ position: "absolute", left: 10, top: "50%", transform: "translateY(-50%)", color: "#bbb", fontSize: 13, pointerEvents: "none" }}>$</span>
                                  <input type="number" min="0" value={apt.movein[f.key]} onChange={e => update(apt.id, f.key, e.target.value)} onWheel={e => e.preventDefault()} placeholder="0"
                                    style={{ width: "100%", padding: "7px 10px 7px 24px", border: "1px solid var(--rose-200)", borderRadius: 8, fontSize: 13, fontFamily: "'DM Sans', sans-serif", background: "var(--warm-white)", color: "var(--dark)", transition: "border-color 0.2s, box-shadow 0.2s" }}
                                  />
                                </div>
                            ...
                            {total > 0 && moveInTotal > 0 && (
                              <div style={{ marginTop: 12, padding: "10px 14px", borderRadius: 10, background: "var(--rose-50)", border: "1px solid rgba(122,156,189,0.2)" }}>
                        ...
                        <div style={{ marginTop: 18 }}>
                          <div style={{ fontSize: 9.5, letterSpacing: 1.8, textTransform: "uppercase", color: "var(--rose-700)", fontWeight: 600, marginBottom: 6 }}>Notes</div>
                          <textarea value={apt.notes} onChange={e => update(apt.id, "notes", e.target.value)} placeholder="Lease terms, move-in timeline, vibe..."
                            style={{ width: "100%", border: "1px solid var(--rose-200)", borderRadius: 10, padding: "10px 13px", fontSize: 12.5, fontFamily: "'DM Sans', sans-serif", color: "#3a3a3a", resize: "vertical", minHeight: 56, background: "var(--warm-white)", lineHeight: 1.55, transition: "border-color 0.2s, box-shadow 0.2s" }}
                          />
                        </div>
            ...
            <div style={{ display: "flex", gap: 10 }}>
              <button onClick={addApartment} className="ripple" style={{
                ...
                background: "transparent", cursor: "pointer", color: "var(--rose-700)", fontFamily: "'DM Sans', sans-serif",
              ...
              {apartments.length > 1 && (
                <button onClick={clearAll} style={{
                  padding: "14px 16px", border: "1.5px solid var(--rose-200)", borderRadius: 14,
                  background: "transparent", cursor: "pointer", color: "var(--rose-700)", fontFamily: "'DM Sans', sans-serif", fontSize: 12, transition: "all 0.2s"
                }}
        ...
        {view === "input" && showComparison && filledApts.length > 1 && (
          <div style={{ background: "#fff", borderRadius: 16, border: "1.5px solid var(--rose-200)", overflow: "hidden", boxShadow: "0 4px 20px rgba(0,0,0,0.05)" }}>
            <div style={{ padding: isMobile ? "12px 16px" : "15px 20px", background: "linear-gradient(135deg, #fbeaef 0%, #f6d5df 100%)", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <span style={{ fontSize: 9.5, letterSpacing: 1.8, textTransform: "uppercase", color: "var(--rose-600)", fontWeight: 600 }}>Side-by-Side Comparison</span>
              <span style={{ fontSize: 9, color: "var(--rose-700)" }}>sorted low → high</span>
            </div>
            <div className="comparison-table-wrapper" style={{ overflowX: "auto" }}>
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12.5 }}>
                <thead>
                  <tr style={{ borderBottom: "1px solid var(--rose-200)", background: "#faf8f5" }}>
                    <th style={{ textAlign: "left", padding: "10px 16px", color: "var(--rose-700)", fontWeight: 600, fontSize: 10.5, textTransform: "uppercase", letterSpacing: 0.8, width: "36%" }}>Category</th>
                    {sorted.filter(a => getTotal(a) > 0).map(apt => (
                      <th key={apt.id} style={{ textAlign: "right", padding: "10px 12px", fontSize: 10.5, fontWeight: 600, color: apt.id === cheapestId ? "var(--green)" : apt.id === expensiveId ? "var(--coral)" : "var(--dark)", whiteSpace: "nowrap" }}>
                        ...
                        {apt.neighborhood && <div style={{ fontSize: 8.5, fontWeight: 400, color: "var(--rose-700)", marginTop: 1 }}>📍 {apt.neighborhood}</div>}
                        {apt.unit && <div style={{ fontSize: 8.5, fontWeight: 400, color: "var(--rose-700)" }}>Unit {apt.unit}</div>}
                ...
                <tbody>
                  ...
                  {sorted.some(a => a.sqft && getTotal(a) > 0) && (
                    <tr style={{ borderTop: "1px solid var(--rose-200)" }}>
                      <td style={{ padding: "8px 16px", color: "var(--rose-700)", fontSize: 11.5 }}>Cost / Sq Ft</td>
                      {sorted.filter(a => getTotal(a) > 0).map(apt => { const t = getTotal(apt), sq = Number(apt.sqft); return <td key={apt.id} style={{ textAlign: "right", padding: "8px 12px", color: "var(--rose-700)", fontSize: 11.5 }}>{sq && t > 0 ? `$${(t/sq).toFixed(2)}/sqft` : "—"}</td>; })}
                    </tr>
                  )}
                  {sorted.some(a => getMoveInTotal(a) > 0) && (
                    <tr style={{ borderTop: "1px solid var(--rose-200)", background: "rgba(122,156,189,0.04)" }}>
                      <td style={{ padding: "8px 16px", color: "var(--rose-400)", fontSize: 11.5, fontWeight: 500 }}>📋 Move-In Total</td>
                      {sorted.filter(a => getTotal(a) > 0).map(apt => { const mi = getMoveInTotal(apt); return <td key={apt.id} style={{ textAlign: "right", padding: "8px 12px", color: mi > 0 ? "var(--rose-400)" : "#ccc", fontSize: 11.5, fontWeight: mi > 0 ? 500 : 400 }}>{mi > 0 ? `$${mi.toLocaleString()}` : "—"}</td>; })}
                    </tr>
                  )}
                  {sorted.some(a => a.dateAvailable) && (
                    <tr style={{ borderTop: "1px solid var(--rose-200)" }}>
                      <td style={{ padding: "8px 16px", color: "var(--rose-700)", fontSize: 11.5 }}>📅 Available</td>
                      {sorted.filter(a => getTotal(a) > 0).map(apt => (
...
function MetaInput({ label, value, onChange, placeholder, type = "text" }) {
  return (
    <div style={{ minWidth: 0, maxWidth: "100%", overflow: "hidden" }}>
      <div style={{ fontSize: 9.5, letterSpacing: 1.2, textTransform: "uppercase", color: "var(--rose-700)", fontWeight: 600, marginBottom: 5 }}>{label}</div>
      <input type={type} value={value} onChange={e => onChange(e.target.value)} onWheel={type === "number" ? e => e.preventDefault() : undefined} placeholder={placeholder}
        style={{
          display: "block", width: "100%", maxWidth: "100%", border: "1px solid var(--rose-200)", borderRadius: 9, padding: "10px 11px",
          fontSize: 12.5, fontFamily: "'DM Sans', sans-serif", color: value ? "var(--dark)" : "var(--gray)",
          background: "var(--warm-white)", transition: "border-color 0.2s, box-shadow 0.2s", boxSizing: "border-box",
